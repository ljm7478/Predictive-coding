...
# layers4_output_modes = ['A0', 'A1', 'A2', 'A3'] 
...
weights_file = os.path.join('{}/prednet/train/Titanic_train_60epoch_layers4_48channel_pretrain_setting.hdf5'.format(Titanic_WEIGHTS_DIR)) 
json_file = os.path.join('{}/prednet/train/Titanic_train_60epoch_layers4_48channel_pretrain_setting.json'.format(Titanic_WEIGHTS_DIR))  
...
for run in runs:
    ...
    for output_mode in layers4_output_modes:
        ...
        save_dir= os.path.join('{}/prednet_original/npy/no_pretrain_same_kitti_pt_setting/{}'.format(GUMP_Results_DIR, run))
        print(save_dir)
