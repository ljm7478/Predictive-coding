...
pretrained_json_file = './data/00_KITTI_pre-train/weights/Original/prednet_kitti_5layers_nopool_model_Lall.json'
pretrained_weights_file = './data/00_KITTI_pre-train/weights/Original/prednet_kitti_5layers_nopool_weights_Lall.hdf5'

# Where to save the fine-tuned model
save_model = True
output_dir = os.path.join(Titanic_WEIGHTS_DIR, 'prednet', 'pt_kitti_ft_Lall_nt150', 'layer5_nopool')
