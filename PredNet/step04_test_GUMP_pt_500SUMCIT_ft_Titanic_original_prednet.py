...
weights_file = os.path.join('{}/prednet/pt_500SUMCIT_ft_Lall_nt150/layer4/weights.hdf5'.format(Titanic_WEIGHTS_DIR)) 
json_file = os.path.join('{}/prednet/pt_500SUMCIT_ft_Lall_nt150/layer4/model.json'.format(Titanic_WEIGHTS_DIR)) 
...
for run in runs:
    ...
    for output_mode in layers4_output_modes:
        ...
        save_dir= os.path.join('{}/prednet_original/npy/CIT_500SUM_pretrained_Lall_nt150_finetuned/layer4/{}'.format(GUMP_Results_DIR, run))
        print(save_dir)
