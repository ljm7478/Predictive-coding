...
class PredNet(Recurrent):
        ...
        for c in sorted(self.conv_layers.keys()):  #jmlee: 0:'a', 1:'c', 2:'f', 3:'i', 4:'o', 5:'ahat'
            for l in range(len(self.conv_layers[c])):
                ...
                if c == 'ahat':
                    ...
                    nb_channels = 2 * self.stack_sizes[l]  #jmlee: 6
                else:
    ...
    def step(self, a, states):
        ...
        e_tm1 = states[2*self.nb_layers:3*self.nb_layers]           #jmlee, [8:12]-> [0,1,2,3]
        ...
        for l in reversed(range(self.nb_layers)):
            inputs = [r_tm1[l], e_tm1[l]]  #jmlee ex) if l=3, inputs (?, 16,20,576) = [(?,16,20,192), (?,16,20, 384)]
        ...
        for l in range(self.nb_layers):
            # print('layer number is {}'.format(str(l)))
