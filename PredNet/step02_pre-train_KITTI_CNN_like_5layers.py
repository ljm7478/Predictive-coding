...
save_model = True
weights_file = os.path.join(SAVE_DIR, 'prednet_kitti_5layers_nopool_weights_Lall.hdf5') # Unique filename
json_file = os.path.join(SAVE_DIR, 'prednet_kitti_5layers_nopool_model_Lall.json') # Unique filename
history_file = os.path.join(SAVE_DIR, 'prednet_kitti_5layers_nopool_model_Lall_history.csv')
...
A_filt_sizes = (3, 3, 3, 3)          # nb_layers - 1
