...
weights_file = os.path.join('{}/CNN_like/pt_kitti_ft_Lall_nt150/layer5_nopool/weights.hdf5'.format(Titanic_WEIGHTS_DIR)) 
json_file = os.path.join('{}/CNN_like/pt_kitti_ft_Lall_nt150/layer5_nopool/model.json'.format(Titanic_WEIGHTS_DIR)) 
...
for run in runs:
    ...
    for output_mode in layers5_output_modes:
        ...
        save_dir= os.path.join('{}/CNN_like/npy/pt_kitti_ft_Lall_nt150/layer5_nopool/{}'.format(GUMP_Results_DIR, run))
        print(save_dir)
