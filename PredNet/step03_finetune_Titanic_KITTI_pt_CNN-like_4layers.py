...
pretrained_json_file = './data/00_KITTI_pre-train/weights/CNN_like/prednet_kitti_4layers_model_Lall.json'   #channels_first
pretrained_weights_file = './data/00_KITTI_pre-train/weights/CNN_like/prednet_kitti_4layers_weights_Lall.hdf5'   #channels_first

# Where to save the fine-tuned model
save_model = True
output_dir = os.path.join(Titanic_WEIGHTS_DIR, 'CNN_like', 'pt_kitti_ft_Lall_nt150', 'layer4')
