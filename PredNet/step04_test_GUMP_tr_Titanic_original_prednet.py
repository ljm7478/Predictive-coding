...
# layers4_output_modes = ['C0', 'C1', 'C2', 'C3'] 
layers4_output_modes = ['I0', 'I1', 'I2', 'I3', 
                        'F0', 'F1', 'F2', 'F3']
...
weights_file = os.path.join('{}/prednet/Titanic_train_250epoch_layers4_32channel.hdf5'.format(Titanic_WEIGHTS_DIR)) 
json_file = os.path.join('{}/prednet/Titanic_train_250epoch_layers4_32channel.json'.format(Titanic_WEIGHTS_DIR)) 

# weights_file = os.path.join('{}/prednet/pt_kitti_ft_Lall_nt150/weights.hdf5'.format(Titanic_WEIGHTS_DIR)) 
# json_file = os.path.join('{}/prednet/pt_kitti_ft_Lall_nt150/model.json'.format(Titanic_WEIGHTS_DIR)) 
...
for run in runs[7:8]:
    ...
    for output_mode in layers4_output_modes:
        ...
        save_dir= os.path.join('{}/prednet_original/npy/prednet_original/layer4/1frame_prediction/{}'.format(GUMP_Results_DIR, run))
        print(save_dir)
