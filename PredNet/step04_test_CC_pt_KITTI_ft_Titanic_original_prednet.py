...
# --- Load Test Data ---
test_file = os.path.join(CC_HICKLE_DUMP, 'X_test.hkl')
test_sources = os.path.join(CC_HICKLE_DUMP, 'sources_test.hkl')
...
for output_mode in layers4_output_modes:
    ...
    save_dir= '/combinelab/03_user/jungmin/01_project/02_PredNet/jmPNET/data/07_CamCAN/result/finetune/' 
    print(save_dir)
