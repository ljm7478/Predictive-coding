...
DATA_DIR = './data/06_NNDB/CIT_500SUM/hkl'
# Path to save the weights for this specific 4-layer model
WEIGHTS_DIR = './data/06_NNDB/CIT_500SUM/weights' # Specific directory for 4 layers

save_model = True
# Corrected filenames to reflect 4 layers
weights_file = os.path.join(WEIGHTS_DIR, 'fix_overfitted', 'prednet_movie_4layers_Lall_nt10_weights_Lall.hdf5')
json_file = os.path.join(WEIGHTS_DIR,'fix_overfitted',  'prednet_movie_4layers_Lall_nt10_model_Lall.json')
history_file = os.path.join(WEIGHTS_DIR, 'fix_overfitted', 'prednet_movie_4layers_Lall_nt10_history.csv')
...
### Worked but could be overfitted
# nb_epoch = 150
# batch_size = 4
