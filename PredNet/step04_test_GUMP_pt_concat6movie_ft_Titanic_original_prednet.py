...
weights_file = os.path.join('{}/prednet/pt_concat6movies_ft_Lall_nt150/layer4/fix_hyperparameter_intermediate/weights.hdf5'.format(Titanic_WEIGHTS_DIR)) 
json_file = os.path.join('{}/prednet/pt_concat6movies_ft_Lall_nt150/layer4/fix_hyperparameter_intermediate/model.json'.format(Titanic_WEIGHTS_DIR)) 
...
for run in runs[0:1]:
    ...
    for output_mode in layers4_output_modes[0:1]:
        print('output_mode is '+ str(output_mode))

        save_dir= os.path.join('{}/prednet_original/npy/pt_concat6movies_ft_Lall_nt150/layer4/{}'.format(GUMP_Results_DIR, run))
        print(save_dir)
