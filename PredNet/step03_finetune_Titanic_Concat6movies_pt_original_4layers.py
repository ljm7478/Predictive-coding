...
pretrained_json_file = './data/06_concat6movie/weights/prednet_movie_4layers_Lall_nt10_model_Lall_success.json'
pretrained_weights_file = './data/06_concat6movie/weights/prednet_movie_4layers_Lall_nt10_weights_Lall_success.hdf5'   

# Where to save the fine-tuned model
save_model = True
output_dir = os.path.join(Titanic_WEIGHTS_DIR, 'prednet', 'pt_concat6movies_ft_Lall_nt150', 'layer4', 'fix_hyperparameter_final3')
