...
pretrained_json_file = './data/06_NNDB/CIT_500SUM/weights/fix_overfitted/prednet_movie_4layers_Lall_nt10_model_Lall.json'
pretrained_weights_file = './data/06_NNDB/CIT_500SUM/weights/fix_overfitted/prednet_movie_4layers_Lall_nt10_weights_Lall.hdf5'   

# Where to save the fine-tuned model
save_model = True
output_dir = os.path.join(Titanic_WEIGHTS_DIR, 'prednet', 'pt_500SUMCIT_ft_Lall_nt150', 'layer4', 'fix_overfitted_lr_0.00001')
...
finetune_model.compile(loss='mean_absolute_error', optimizer=Adam(lr=0.00001))
