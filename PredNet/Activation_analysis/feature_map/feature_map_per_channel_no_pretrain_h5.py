...
# --- Configuration ---
BASE_RESULTS_DIR = '/combinelab/03_user/jungmin/01_project/02_PredNet/jmPNET/data/01_gump/result/prednet_original/h5/no_kitti_pretrain/layer4/1frame_prediction'
PLOTS_SAVE_DIR = '/combinelab/03_user/jungmin/01_project/02_PredNet/jmPNET/data/99_feature_kernel_map/original_prednet/layer4/feature_map/no_finetune'
...
def visualize_all_channels(data, layer_name, timestep, save_dir, resize_to=(64, 64)):
    ...
    if layer_family_match:
        ...
        family_save_dir = os.path.join(save_dir, layer_family)
...
if __name__ == "__main__":
    ...
    for layer_type in layers_types:
        for layer_name in layers_to_load:
            h5_path = os.path.join(run_dir, "{}_{}.h5".format(RUN_TO_PLOT,layer_type))

            if os.path.exists(h5_path): 
                print("Loading {}...".format(h5_path)) 
                try:
                ...
                print("Warning: Could not find {}. Skipping.".format(h5_path)) 
