...
# dir path 
Titanic_WEIGHTS_DIR = '/combinelab/03_user/jungmin/01_project/02_PredNet/jmPNET/data/02_Titanic/weights'
...
for run in runs: 
    ...
    weights_file = os.path.join('{}/Titanic_train_250epoch_layers5_96channel_originalprednet.hdf5'.format(Titanic_WEIGHTS_DIR)) 
    json_file = os.path.join('{}/Titanic_train_250epoch_layers5_96channel_originalprednet.json'.format(Titanic_WEIGHTS_DIR)) 
    ...
    for output_mode in layers5_output_modes:
        ...
        save_dir= os.path.join('{}/result/original_prednet/layers5_3_32_64_96_192channel/{}'.format(AlexNet_base_dir, str(run)))
        print(save_dir)
