...
for lay = 1 : length(layername)
    ...
    save([saveroot,'AlexNet_feature_maps_processed_layer',num2str(lay),'_concatenated.mat'],...
...
load([alexnet_fmri_root,subject_id, 'training_fmri.mat'],'fmri'); % from movie_fmri_processing.m
