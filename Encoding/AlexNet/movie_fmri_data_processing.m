...
% save fmri
savepath = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/AlexNet/fMRI/';
save([savepath,'training_fmri.mat'], 'fmri', 'Rmat');
...
% save fmritest
save([savepath,'testing_fmri.mat'], 'fmritest', '-v7.3');
