...
feature_path = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/Jmlee_test/encoding_analysis/modified_prednet/Unpredictable_stimulus/layer7/Ahat';
...
save_path = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/Jmlee_test/encoding_analysis/modified_prednet/Unpredictable_stimulus/layer7/Ahat';
...
for config_idx = 1:size(configs, 1)
    ...
    for stim = fieldnames(stimulus_mapping)'
        ...
        save_file_name = fullfile(save_path, sprintf('%s_%s_lambda5_Ahat.dtseries.nii', test_date(1:6),task_name ));
...
for stim = fieldnames(stimulus_mapping)'
    ...
    for config_idx = 1:size(configs, 1)
        ...
        dtseries_file = fullfile(dtseries_path, sprintf('%s_%s_lambda5_Ahat.dtseries.nii', test_date(1:6), task_name));
    ...
    cii.cdata = avg_cdata;
    save_file_name = fullfile(dtseries_path, sprintf('%s_lambda5_Ahat_avg.dtseries.nii', task_name));
