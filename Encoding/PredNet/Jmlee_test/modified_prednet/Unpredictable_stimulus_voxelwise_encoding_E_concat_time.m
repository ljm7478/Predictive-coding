...
% save_path = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/Jmlee_test/encoding_analysis/modified_prednet/concat_time/Unpredictable_stimulus/layer7/E/garbor/';
...
% corr_path = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/Jmlee_test/encoding_analysis/modified_prednet/concat_time/Unpredictable_stimulus/layer7/E/garbor/';
% fmripath = '/combinelab2/03_user/jungmin/02_data/02_jmlee_fmri/02_fmri/Preprocessed/241119_noT1/output/ciftify/sub-01/MNINonLinear/Results/task-CircleUnpred_run-02/task-CircleUnpred_run-02_Atlas_s3.dtseries.nii';
% 
...
save_path = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/Jmlee_test/encoding_analysis/modified_prednet/concat_time/Unpredictable_stimulus/layer7/E/movie';
% layername = {'/E0'; '/E1'; '/E2'; '/E3';};
layername = {'/E0'; '/E1'; '/E2'; '/E3';  '/E4';  '/E5';  '/E6';};
...
%% Process Each Configuration
clc;
for config_idx = 2:size(configs, 1)
    train_dates = configs{config_idx, 1};
    test_date = configs{config_idx, 2};
    train_dates_clean = cellfun(@(d) d(1:6), train_dates, 'UniformOutput', false);
...
clc;
% Paths for CIFTI and correlation files
corr_path = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/Jmlee_test/encoding_analysis/modified_prednet/concat_time/Unpredictable_stimulus/layer7/E/movie/';
fmripath = '/combinelab2/03_user/jungmin/02_data/02_jmlee_fmri/02_fmri/Preprocessed/241119_noT1/output/ciftify/sub-01/MNINonLinear/Results/task-CircleUnpred_run-02/task-CircleUnpred_run-02_Atlas_s3.dtseries.nii';
