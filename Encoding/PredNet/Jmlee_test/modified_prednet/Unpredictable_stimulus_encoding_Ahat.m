...
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/Jmlee_test/encoding_analysis/modified_prednet/Unpredictable_stimulus/layer7/Ahat/';
...
stimulus_type = {'circle', 'garbor_frequency', 'garbor_orientation', 'garbor_sc'};  %{'garbor_frequency'}
session_type = 'unpredictable_30fps';
...
for session_idx = 1:size(sessions, 1)
    ...
    for lay = 1: length(layername)
        ...
        for stim = 1:length(curr_stimulus_type)
            ...
            dataroot = fullfile(base_dir, curr_stimulus_type{stim}, curr_session_type, 'result/prednet_CNN_like_ver2_A_pass/h5/layer7/');
            secpath = fullfile(dataroot, 'Ahat.h5');
...
%% Close parallel pool
% delete(gcp('nocreate'));
% disp('All computations completed.');