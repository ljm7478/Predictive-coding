...
% saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/Jmlee_test/encoding_analysis/modified_prednet/concat_time/Predictable_stimulus/layer7/C/garbor/';
% 
...
% 
%         % Path to the H5 file
%         dataroot = fullfile(base_dir, stimulus_type{stim}, session_type, 'result/prednet_CNN_like_ver2_A_pass/h5/layer7/');
%         secpath = fullfile(dataroot, 'C.h5');
% 
...
% Base directory and save root
base_dir = '/combinelab/03_user/jungmin/01_project/02_PredNet/jmPNET/data/05_jmlee_stimuli/PredNetExp';
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/Jmlee_test/encoding_analysis/modified_prednet/concat_time/Predictable_stimulus/layer7/C/movie/';
