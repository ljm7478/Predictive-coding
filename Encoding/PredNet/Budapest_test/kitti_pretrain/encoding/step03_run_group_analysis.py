"""
Step 5: Group-Level Analysis for Correlation and Beta Maps - Budapest Dataset
...
def run_step5_group_analysis():
    ...
    """
    print("\n" + "="*70)
    print(f" Step 5: Group-Level Analysis - Budapest ({FEATURE_TYPE})")
    print("="*70)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Budapest Step 5: Group Analysis")
