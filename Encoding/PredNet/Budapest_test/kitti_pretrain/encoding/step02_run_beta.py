"""
Step 4: Compute Beta Maps from W matrices using PCA (PC1 loadings) - Budapest Dataset
...
def run_step4_beta_maps(method='pc1'):
    ...
    """
    print("\n" + "="*70)
    print(f" Step 4: Computing Beta Maps - Budapest ({FEATURE_TYPE})")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Budapest Step 4: Beta Maps")
