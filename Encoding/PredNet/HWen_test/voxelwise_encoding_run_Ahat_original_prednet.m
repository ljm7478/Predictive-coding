...
fmri_subject = {'subject2', 'subject3'};
subs = {'sub2', 'sub3'};
for fmri_sub = 1: length(fmri_subject)
    ...
    dataroot='/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/original_prednet/layers5_3_32_64_96_192channel/Ahat/';
    saveroot = ['/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/original_prednet/layers5_3_32_64_96_192channel/Ahat/', subject_id, '/'];
...
for fmri_sub = 1: length(fmri_subject)
    ...
    % %modified-96c
    % dataroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/original_prednet/layers5_96_256_384_384_256channel/Ahat/';
    % saveroot = ['/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/original_prednet/layers5_96_256_384_384_256channel/Ahat/', subject_id, '/'];
    ...
    save_file_name = fullfile(saveroot, [subject_id,'_lambda5_Ahat.dtseries.nii']);
...
% total sub encoding 
clc;clear
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/original_prednet/layers5_3_32_64_96_192channel/Ahat/';
...
for lay = 1:num_layers
    ...
    for s = 1:num_subjects
        ...
        dataroot = ['/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/original_prednet/layers5_3_32_64_96_192channel/Ahat/', subject_id, '/'];
        file_name = [subject_id, '_corr_lambda5_', layername{lay}(2:end), '.mat'];
