...
dataroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/bivariate_analysis/layers5_32_64_96_193channel/modified_prednet/A/';
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/hiearchical_mapping/layers5_3_32_64_96_192channel/modified_prednet/A/';
...
%% Load fmri responses
fmriroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/subject1_fmri/';
...
% 
% for lay = 1 : length(layername)
%     load([dataroot,'PredNet_feature_maps_processed_layer',num2str(lay),'_A', '_concatenated.mat'],'lay_feat_concatenated');
...
%        k1 = k2+1;
%     end
%     save([saveroot, 'cross_corr_fmri_cnn_layer',num2str(lay),'_A', '.mat'], 'Rmat', '-v7.3');
% end
% 
...
for lay = 1 : length(layername)
    load([saveroot,'PredNet_feature_maps_processed_layer',num2str(lay),'_A', '_concatenated.mat'],'lay_feat_concatenated');
    dim = size(lay_feat_concatenated);
    Nu = prod(dim(1:end-1));% number of units
    Nf = dim(end); % number of time points
    lay_feat_concatenated = reshape(lay_feat_concatenated, Nu, Nf)';
    ...
    save([saveroot, 'jmlee_sub1_cross_corr_fmri_cnn_layer',num2str(lay),'_A', '.mat'], 'Rmat', '-v7.3');
end
...
for lay = 1 : length(layername)
    disp(['Layer: ',num2str(lay)]);
    load([saveroot, 'jmlee_sub1_cross_corr_fmri_cnn_layer',num2str(lay),'_A', '.mat'],'Rmat');
    lay_corr(lay,:) = max(Rmat,[],1);
...
save([saveroot, 'jmlee_sub1_cross_max_corr_fmri_cnn_A.mat'], 'lay_corr');
save([saveroot, 'jmlee_sub1_cross_max_corr_layidx_fmri_cnn_A.mat'], 'layidx');
...
dataroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/hiearchical_mapping/layers5_32_64_96_193channel/A/';

%load max_lay_cor
load([dataroot, 'jmlee_sub1_cross_max_corr_fmri_cnn_A.mat'],'lay_corr');
size(lay_corr)
...
save_file_name = fullfile(dataroot, [subject_id,'_WH_max_laycorr_A.dtseries.nii']);
...
%load max_lay_idx
load([dataroot, 'jmlee_sub1_cross_max_corr_layidx_fmri_cnn_A.mat'],'layidx');
...
cii.diminfo{1, 2}.length = size(cii.cdata, 2);
cii.diminfo{1, 1}.models(3:end) = [];
save_file_name = fullfile(dataroot, [subject_id,'_WH_max_layidx_A.dtseries.nii']);
ciftisavereset(cii, (save_file_name), 'wb_command');
...
cii.diminfo{1, 2}.length = size(cii.cdata, 2);
cii.diminfo{1, 1}.models(3:end) = [];
save_file_name = fullfile(dataroot, [subject_id,'_visual_max_laycorr_A.dtseries.nii']);
ciftisavereset(cii, (save_file_name), 'wb_command');
...
dataroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/hiearchical_mapping/layers5_32_64_96_193channel/';
...
cii.diminfo{1, 2}.length = size(cii.cdata, 2);
cii.diminfo{1, 1}.models(3:end) = [];
save_file_name = fullfile(dataroot, [subject_id,'_visual_max_layidx_A.dtseries.nii']);
ciftisavereset(cii, (save_file_name), 'wb_command');
...
dataroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/bivariate_analysis/layers5_32_64_96_193channel/';
