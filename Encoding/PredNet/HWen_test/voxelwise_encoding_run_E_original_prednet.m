...
for fmri_sub = 1: length(fmri_subject)
    ...
    % %modified-96c
    % dataroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/original_prednet/layers5_96_256_384_384_256channel/E/';
    % saveroot = ['/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/original_prednet/layers5_96_256_384_384_256channel/E/', subject_id, '/'];
    ...
    cancat_filename = 'concat_corr.mat';

    save([saveroot, cancat_filename], 'concat_corr', '-v7.3');
    ...
    %load cii structure
    fmri_subject_id='subject1';
    fmripath =['/combinelab2/03_user/jungmin/02_data/03_NeuralEncodingDecoding/', fmri_subject_id, '/video_fmri_dataset/', fmri_subject_id, '/fmri/']; % path to the cifti files
    seg = 1;
...
% total sub encoding 
clc;clear
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/original_prednet/layers5_3_32_64_96_192channel/E/';
...
for lay = 1:num_layers
    ...
    for s = 1:num_subjects
        ...
        dataroot = ['/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/original_prednet/layers5_3_32_64_96_192channel/E/', subject_id, '/'];
        file_name = [subject_id, '_corr_lambda5_', layername{lay}(2:end), '.mat'];
...
save([saveroot, sprintf('%s_avg_corr.mat', layername{lay}(2:end))], 'corr_avg', '-v7.3');
...
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/E/';
layername = {'/E1';'/E2';'/E3';'/E4';}; 
...
% lay1=load([saveroot, 'corrE1.mat']).R;
% lay2=load([saveroot, 'corrE2.mat']).R;
% lay3=load([saveroot, 'corrE3.mat']).R;
% lay4=load([saveroot, 'corrE4.mat']).R;

lay1=load([saveroot, 'corr_avg_visual_E1.mat']).R;
lay2=load([saveroot, 'corr_avg_visual_E1.mat']).R;
lay3=load([saveroot, 'corr_avg_visual_E3.mat']).R;
lay4=load([saveroot, 'corr_avg_visual_E4.mat']).R;
