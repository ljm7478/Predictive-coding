...
fmripath = '/combinelab2/03_user/jungmin/02_data/03_NeuralEncodingDecoding/subject3/video_fmri_dataset/subject3/fmri/'; % path to the cifti files
% saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/subject3_fmri/';
...
% save fmri
save([saveroot,'training_fmri.mat'], 'fmri', 'Rmat');
...
fmripath = '/combinelab/03_user/jungmin/02_data/08_NeuralEncodingDecoding/subject3/video_fmri_dataset/subject3/fmri/'; % path to the cifti files
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/subject3_fmri/';
...
% save fmritest
save([saveroot,'testing_fmri.mat'], 'fmritest', '-v7.3');