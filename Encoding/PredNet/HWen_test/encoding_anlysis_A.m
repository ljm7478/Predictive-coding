...
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/layers5_96_256_384_384_256channel/modified_prednet/A/';
...
for lay = 1 : length(layername)
    ...
    for seg = 1 : 18
        ...
        % secpath =  [dataroot,'seg', num2str(seg), '_A', '.Eh5'];
...
%227*227 img size
dataroot = '/combinelab/03_user/jungmin/01_project/02_PredNet/jmPNET/data/05_AlexNet/result/modified_prednet/layers5_96_256_384_384_256channel/h5/';
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/AlexNet_test/encoding_analysis/layers5_96_256_384_384_256channel/modified_prednet/E/';
...
for lay = 1 : length(layername)
    ...
    for seg = 1 : 5
        ...
        % secpath =  [dataroot,'test', num2str(seg), '_Ahat', '.h5'];
        % secpath =  [dataroot,'test', num2str(seg), '_A', '.h5'];
        secpath =  [dataroot,'test', num2str(seg), '_E', '.h5'];
        if exist(secpath,'file')==2
            lay_feat = h5read(secpath,[layername{lay}]);
            lay_feat = bsxfun(@minus, lay_feat, lay_feat_mean);
            lay_feat = bsxfun(@rdivide, lay_feat, lay_feat_std);
