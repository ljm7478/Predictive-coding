...
Prediction_features = {'run1_R', 'run2_R', 'run3_R', 'run4_R' , 'run5_R', 'run6_R', 'run7_R', 'run8_R'}
...
% calculate the Memory feature temporal mean
for lay = 0:3 
    N = 0;
    for seg = 1 : 8
        feature = Memory_features{seg};
        disp(feature)
...
% calculate the Memory temporal standard deviation
for lay = 0:3
...
for lay = 0:3 
    ...
    lay_feat_mean = h5read(fullfile(saveroot,'/', 'feature_maps','/', '4layers_32channel_img_zise_same', '/',sprintf('E%d_feature_maps_avg.h5',  lay)), '/data');
    lay_feat_std = h5read(fullfile(saveroot,'/', 'feature_maps','/', '4layers_32channel_img_zise_same', '/', sprintf('E%d_feature_maps_std.h5',  lay)), '/data');
   ...
   for feature_idx = 1:numel(features)
        ...
        for seg = 1:8
           ...
           for layer = 0
                ...
                folder_name = [saveroot,'/', 'W','/','4layers_32channel','/','10k', '/',sprintf('seg%d',seg), '/']
                if not(exist(folder_name,'dir'))
                    mkdir(folder_name)
                end
   ...
   for feature_idx = 1:numel(features)
        ...
        for seg = 1:8
           ...
           for layer = 0:3
                ...
                W = load([saveroot,'/', 'W','/', '4layers_32channel', '/', '10k', '/', sprintf('seg%d',seg), '/', num2str(subject), '_', feature, num2str(layer), '_W_svd0.9_s3.mat']);
                name = ['Y_pred_', feature, num2str(layer)] 
                eval([name, '= X*W.W;']);
                
                folder_name = [saveroot,'/', 'Y_hat','/','4layers_32channel', '/', '10k', '/',sprintf('seg%d',seg), '/']
                if not(exist(folder_name,'dir'))
                    mkdir(folder_name)
                end
...
for i = 2:15
    ...
    for feature_idx = 1:numel(features)
        ...
        for layer= 0:3
            for seg = 1:8
                folder_name = [saveroot,'/', 'correlations','/', '4layers_32channel','/', '10k', '/', 'jm_test', '/',  sprintf('seg%d',seg)]
                if not(exist(folder_name,'dir'))
                    mkdir(folder_name)
                end

                Y_pred = load([saveroot,'/', 'Y_hat','/','4layers_32channel','/','10k', '/', sprintf('seg%d',seg), '/', strcat(num2str(subject),'_', feature , num2str(layer),'_pred_svd0.9_s3', '.mat')]);
                Y_pred = Y_pred.Yhat;
                ...
                save([saveroot,'/', 'correlations','/', '4layers_32channel','/', '10k', '/', 'jm_test', '/',sprintf('seg%d',seg), '/', name], 'correlations', '-v7.3');
...
folder_name = [saveroot,'/', 'correlations','/', '4layers_32channel','/', '10k', '/', 'jm_test', '/', 'total', '/']
if not(exist(folder_name,'dir'))
    mkdir(folder_name)
end
...
for i = 1:15
    ...
    for feature_idx = 1:numel(features)
        ...
        for layer= 0:3
            for seg = 1:8
                Y_hat = load([saveroot,'/', 'Y_hat','/','4layers_32channel','/','10k', '/',  sprintf('seg%d',seg), '/', strcat(num2str(subject),'_', feature , num2str(layer),'_pred_svd0.9_s3', '.mat')]);
...
for feature_idx = 1:numel(features)
    ...
    save([saveroot,'/', 'correlations','/', '4layers_32channel','/', '10k', '/', 'jm_test', '/', 'total', '/', sprintf('%s_avg_corr_svd0.90_s3.mat', feature)], 'Y_hat', '-v7.3');
    Y_hat = {};
...
for feature_idx = 1:numel(features)
    ...
    disp(feature)
            ...
            for layer=0:3
                ...
                % Load correlation
                load([saveroot,'/', 'correlations','/', '4layers_32channel','/', '10k', '/', 'jm_test', '/', 'total', '/',sprintf('%s_avg_corr_svd0.90_s3.mat', feature)]);
