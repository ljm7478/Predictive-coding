...
for feature_idx = 1:numel(features)
    ...
    for layer = 0:3
        for seg = 1:8
            filename = sprintf('%s/X/4layers/%s%d_svd0.9hrf_seg%d.mat', saveroot, feature, layer, seg);
...
for i = 1:15
    ...
    for layer= 0:5
        for seg = 1:8
            ...
            prediction_folder_name = [saveroot,'/', 'ratio','/6layers_per_seg/', 'Yhat', '/', 'Y_hat_P','/', sprintf('seg%d',seg),'/']
            ...
            %load Yhat_error
            error_folder_name = [saveroot,'/', 'ratio','/6layers_per_seg/', 'Yhat', '/','Y_hat_E','/', sprintf('seg%d',seg),'/']
            ...
            total_folder_name = [saveroot,'/', 'ratio','/6layers_per_seg/', 'Yhat', '/', 'Y_hat_P+E','/', sprintf('seg%d',seg),'/']
...
ratio_dir = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/ratio/6layers/ratio_map/';
saveroot='/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/ratio/6layers/dt_result/';
