...
BASE_SAVE_DIR = "/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/modified_prednet/kitti_pretrain_result/four_train_four_test_PCAcap/layer4"
...
def run_step4_beta_maps(method='pc1'):
    ...
    """
    print("\n" + "="*70)
    print(f" Step 4: Computing Beta Maps - Gump ({FEATURE_TYPE})")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Gump Step 4: Beta Maps")
