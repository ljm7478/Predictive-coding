...
# Raw beta paths 
BETA_DIR = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/modified_prednet/kitti_pretrain_result/LORO_PCAcap/layer4'

# NC Normalized beta paths
# Option 1: No threshold (original)
NC_BETA_DIR = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/modified_prednet/kitti_pretrain_result/LORO_PCAcap/layer4/divergence_analysis/step1_normalized/no_thresh_range_global_merged'

# Option 2: With ISC threshold 0.1 
# NC_BETA_DIR = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/modified_prednet/kitti_pretrain_result/LORO_PCAcap/layer4/divergence_analysis/step1_normalized_ISC_thresh_0.1'

# NC file names (threshold version)
# NC_AHAT_FILE = 'ahat_beta_norm_thresh.dscalar.nii'  
# NC_E_FILE = 'e_beta_norm_thresh.dscalar.nii'        
...
if USE_NC_THRESHOLD:
    SAVE_DIR = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/modified_prednet/kitti_pretrain_result/LORO_PCAcap/layer4/Results/Q1/layer_profile_NC_ISC_thresh_0.1'
else:
    SAVE_DIR = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/modified_prednet/kitti_pretrain_result/LORO_PCAcap/layer4/Results/Q1/layer_profile'
