...
if DATASET == 'budapest':
    ...
    ENCODING_DIR = "{}/encoding_analysis/modified_prednet/kitti_pretrain_result/four_train_four_test/layer4".format(PROJECT_DIR)
    ...
    ENCODING_DIR = "{}/encoding_analysis/modified_prednet/kitti_pretrain_result/LORO_PCAcap/layer4".format(PROJECT_DIR)
