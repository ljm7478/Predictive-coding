...
% 
% % Define paths
dataroot = '/combinelab/03_user/jungmin/01_project/02_PredNet/jmPNET/data/01_gump/result/prednet_CNN_like_ver2_A_pass/h5/layer7/1frame_prediction';
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/modified_prednet/result/layer7/C/';
...
% CNN layer labels
layername = {'/C0'; '/C1'; '/C2'; '/C3'; '/C4'; '/C5'; '/C6'}; 
dataroot = saveroot; %'/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/modified_prednet/result/layer7/C/';
