...
for t = 1:length(types)
    ...
    dataroot = ['/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/modified_prednet/result/', ...
                layer_name, '/', type, '/'];
    ...
    % Save group average .mat file
    save(fullfile(dataroot, [type '_avg_lambda5.mat']), 'group_avg_corr', '-v7.3');
end
