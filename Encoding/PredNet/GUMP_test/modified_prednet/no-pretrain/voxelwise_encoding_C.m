...
for sub = 1:length(num_subjects)
    ...
    dataroot = ['/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/modified_prednet/result/',layer_name, '/C/'];
    ...
    for run = 5:8 
        ...
        save_file_name = fullfile(dataroot, subject_id, [subject_id,'_lambda5_avg_C_run_', num2str(run), '.dtseries.nii']);
    ...
    save_file_name = fullfile(dataroot, subject_id, [subject_id,'_lambda5_avg_C.dtseries.nii']);
