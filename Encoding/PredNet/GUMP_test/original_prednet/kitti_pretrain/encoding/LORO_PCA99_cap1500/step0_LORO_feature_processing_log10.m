...
SAVE_ROOT = fullfile('/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/original_prednet/kitti_pretrain_result/LORO_PCA99cap1500_log10/layer4/', FEATURE_TYPE);
...
% PCA settings
PCA_VARIANCE_THRESHOLD = 0.99;  % 99% variance target (Wen 2018 / Guclu & van Gerven 2015 convention)
MAX_PCA_COMPONENTS = 1500;      % Hard cap: ~2:1 train-TR-to-PC ratio for ridge stability
                                % LORO total = 3599 TRs across 8 runs
                                % Worst-case min train (leave out run7=542) = 3057 TRs
                                % 3057 / 1500 = 2.04 ratio (safe for ridge)
