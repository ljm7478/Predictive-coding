...
if DATASET == 'budapest':
    ...
    # Gump´Â PCAcap 
    ENCODING_DIR = f"{PROJECT_DIR}/encoding_analysis/original_prednet/kitti_pretrain_result/LORO_PCAcap/layer4"
...
OUTPUT_DIR = f"{ENCODING_DIR}/divergence_analysis/step1_normalized_no_threshold"
