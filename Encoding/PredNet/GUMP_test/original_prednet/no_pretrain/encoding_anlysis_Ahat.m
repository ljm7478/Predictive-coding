...
% 
% % Define paths
dataroot = '/combinelab/03_user/jungmin/01_project/02_PredNet/jmPNET/data/01_gump/result/prednet_original/h5/layer4';
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/original_prednet/result/layer4/Ahat/';
...
for lay = 1:length(layername)
    ...
    for seg = 0:num_train
        secpath = fullfile(dataroot, ['seg', num2str(seg), '/Ahat.h5']);
...
% CNN layer labels
layername = {'/Ahat0'; '/Ahat1'; '/Ahat2'; '/Ahat3'}; 
dataroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/original_prednet/result/layer4/Ahat/';
