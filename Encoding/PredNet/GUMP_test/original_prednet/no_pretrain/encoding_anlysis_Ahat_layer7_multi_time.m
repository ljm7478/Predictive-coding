%% mean and std of training segs (from seg01-04)
clc; clear;

% Define paths
dataroot = '/combinelab/03_user/jungmin/01_project/02_PredNet/jmPNET/data/01_gump/result/prednet_original/h5/layer7/multi_prediction/2second_50frame';
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/original_prednet/multi_time_result/2second_50frame/layer7/Ahat/';
...
% Frame counts for each seg (training: seg1-4, testing: seg5-8)
...
% CNN layer labels
layername = {'/Ahat0'; '/Ahat1'; '/Ahat2'; '/Ahat3'; '/Ahat4'; '/Ahat5'; '/Ahat6'}; 
dataroot = saveroot; %'/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/original_prednet/layer7/Ahat/';
