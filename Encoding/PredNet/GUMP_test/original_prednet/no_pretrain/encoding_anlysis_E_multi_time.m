...
% 
% % Define paths
dataroot = '/combinelab/03_user/jungmin/01_project/02_PredNet/jmPNET/data/01_gump/result/prednet_original/h5/layer4/multi_prediction/2second_50frame';
saveroot = '/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/original_prednet/multi_time_result/2second_50frame/layer4/E/';
...
num_train = 4;  
num_test = 4;   % Frame counts for each seg (training: run1-4, testing: run5-8)
...
for lay = 1:length(layername)
    ...
    for seg = 1:num_train
        secpath = fullfile(dataroot, ['seg', num2str(seg), '_E.h5']);
...
% CNN layer labels
layername = {'/E0'; '/E1'; '/E2'; '/E3'}; 
dataroot = saveroot; %'/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/Titanic_trained/GUMP_test/encoding_analysis/original_prednet/result/layer4/E/';
