...
dataroot = ['/combinelab/03_user/jungmin/01_project/01_Encoding/01_HWen_Encoding/PredNet/', ...
            'Titanic_trained/GUMP_test/encoding_analysis/modified_prednet/result/', ...
            layer_name, '/', type, '/'];
...
save(fullfile(dataroot, ['group_beta_' type '_all_layers_PCA_maxabs.mat']), 'layer_wise_group_beta_maxabs', '-v7.3');
save(fullfile(dataroot, ['group_beta_' type '_all_layers_PCA_zscore.mat']), 'layer_wise_group_beta_zscore', '-v7.3');
